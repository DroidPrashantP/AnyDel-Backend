...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.quadvision.anydel.backend.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.quadvision.anydel.backend.glide.GlideOptions().apply(toSet));
    }
  }
}
